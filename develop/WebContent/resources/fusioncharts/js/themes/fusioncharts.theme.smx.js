...
(function(b) {
    ...
    b.register("theme", {
        ...
        theme: {
            base: {
                chart: {
	            	paletteColors: navy+","+teal+","+blue+","+gray+","+darkGray,
                    labelDisplay: "auto",
                    baseFontColor: "#464646",
                    baseFont: "Source Sans Pro,Roboto,Helvetica Neue,sans-serif",
                    baseFontSize: "16",
                    ...
                    flatScrollBars: "1",
                    scrollShowButtons: "0",
                    scrollColor: lightGray,
                    showHoverEffect: "1",
                    valueFont: "Open Sans,Roboto,Helvetica Neue,sans-serif",
                    valueFontSize: "10",
	                valueFontColor: "#ffffff", 
	                valueBgColor: darkGray,
                	valueBgAlpha:"80",               
                    showXAxisLine: "1",
